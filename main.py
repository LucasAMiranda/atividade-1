...
##Recebendo os 2 valores corretamente e não existindo outra comida com o
##mesmo nome na lista, a função deve adicionar a comida no dicionário
##(food_list).#


def add_food(nome_comida='', descricao_comida=''):
  if type(nome_comida) is not str or type(descricao_comida) is not str:
    print("Cara, ambos valores devem ser string")

  elif nome_comida == '' or descricao_comida == '':
    print("Vc precisa passar os 2 valores")

  elif nome_comida in food_list:
    print("comida ja cadastrada")

  else:
    food_list["nome_comida"] = descricao_comida
